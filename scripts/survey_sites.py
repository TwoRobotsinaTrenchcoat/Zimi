...
SITES = [
    ...
    Site(
        "gobyexample", "https://gobyexample.com/", "released", "gobyexample.com_en_all"
    ),
    ...
    Site(
        "bootstrap", "https://getbootstrap.com/", "released", "getbootstrap.com_en_all"
    ),
    Site(
        "permacomputing",
        "https://permacomputing.net/",
        "released",
        "permacomputing.net_en_all",
    ),
